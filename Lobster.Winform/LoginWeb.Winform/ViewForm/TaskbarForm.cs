...
namespace LoginWeb.Winform.ViewForm
{
    internal partial class TaskbarForm : Form
    {
        ...
        private void DrawText(Graphics graphics)
        {
            ...
            {
                var title= messageList[this.currentMessageIndex].TitleText+"【"+ messageList[this.currentMessageIndex].SendTime + "】";
                graphics.DrawString(" " + title, new System.Drawing.Font("宋体", 10.5F), new SolidBrush(Color.Blue), this.TitlebarRectangle);
