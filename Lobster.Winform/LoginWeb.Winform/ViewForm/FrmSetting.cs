...
{
    public partial class FrmSetting : BaseFormBusiness, IfrmSetting
    {
        public FrmSetting()
        {
            InitializeComponent();
        ...
        public int inputMethod_CH
        {
            ...
            set
            {
                if (comboBoxEx2.Items.Count > value)
                    comboBoxEx2.SelectedIndex = value;
            }
        }
        ...
        public int inputMethod_EN
        {
            ...
            set
            {
                if (comboBoxEx1.Items.Count > value)
                    comboBoxEx1.SelectedIndex = value;
            }
        }

        public void loadPrinter(string[] printers, int first, int second, int three)
        {
            print1.Items.Clear();
            print2.Items.Clear();
            print3.Items.Clear();
            foreach (string mo in printers)
            {
                print1.Items.Add(mo);
        ...
        {
            InvokeController("ShowConfigure");
        }
    }
}
