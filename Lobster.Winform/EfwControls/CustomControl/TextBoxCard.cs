...
namespace EfwControls.CustomControl
{
    ...
    public class TextBoxCard : DevComponents.DotNetBar.Controls.TextBoxX
    {
        ...
        private void SetSelectionCardLocation()
        {
            ...
            cardDataGrid.Height = ShowCardHeight < 260 ? 260 : ShowCardHeight;
        ...
        protected override void OnTextChanged(EventArgs e)
        {
            if (!isSetValue && IsPage == true)
            {
                if (queryFields != null)
                {
                    ...
                    {
                        filterString += "Convert(" + queryFields[i] + ", 'System.String')" + " like '" + s1 + strKey + s2 + "' or ";
                    }
                    filterString += "Convert(" + queryFields[queryFields.Length - 1] + ", 'System.String')" + " like '" + s1 + strKey + s2 + "'";
                    ...
                    if (pressSpacekey)
                    {
                        ...
                        for (int i = 0; i < queryFields.Length - 1; i++)
                        {
                            filterString += "Convert(" + queryFields[i] + ", 'System.String')" + " = '" + strKey + "' or ";
                        }
                        filterString += "Convert(" + queryFields[queryFields.Length - 1] + ", 'System.String')" + " = '" + strKey + "'";
                    }

                    if (_source != null)
                    {
                        //使用RowFilter效率慢，但是Select排序乱了
